--[[
	...
	MapCycle.json
	A Shine command will take a mod hex and boolean and add those to the config.
...
--TODO: Import mods from the mapcycle to the Config file. 
